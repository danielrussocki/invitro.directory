  ...
  return (
    <Form.Root className={formClassName} {...props}>
      ...
      <Form.Submit asChild className="mt-2.5">
        <button className="inline-flex h-9 w-full items-center justify-center rounded bg-white border-2 px-3.5 font-medium leading-none shadow-sm cursor-pointer hover:bg-gray-100 focus:shadow-md focus:outline-none">
          {submitText}
        </button>
      </Form.Submit>
    </Form.Root>
